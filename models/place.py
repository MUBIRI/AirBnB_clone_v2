...
class Place(BaseModel, Base):
    ...
    column1 = Column('place_id', ForeignKey('places.id'), primary_key=True)
    column2 = Column('amenity_id', ForeignKey('amenities.id'),
                     primary_key=True)

    place_amenity = Table('place_amenity', Base.metadata, column1, column2)
